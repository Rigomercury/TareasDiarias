...
class F_Todas : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_f__todas, container, false)

        recylerView_Registros = view.findViewById(R.id.recylerView_Registros)
